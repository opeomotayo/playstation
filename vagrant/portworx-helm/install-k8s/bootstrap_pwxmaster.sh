...
# for flannel
kubeadm init --apiserver-advertise-address=192.168.80.10 --pod-network-cidr=10.244.0.0/16 >> /root/kubeinit.log 2>/dev/null
...
su - vagrant -c "kubectl create -f /vagrant/install-k8s/kube-flannel.yaml"
